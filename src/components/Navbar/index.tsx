...
export default function Navbar() {
  ...
  return (
    <nav className="bg-blue-600 px-4 sm:px-6 py-4 shadow-lg">
          ...
          <form onSubmit={handleSearch} className="relative w-full">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 sm:py-3  text-white placeholder-gray-500 rounded-lg border border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent text-sm sm:text-base"
              />
            </div>
          </form>
        </div>
